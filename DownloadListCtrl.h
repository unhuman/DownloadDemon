...
/////////////////////////////////////////////////////////////////////////////
// CDownloadListCtrl window
class CDownloadListCtrl : public CListCtrl
{
// Construction
public:
	CDownloadListCtrl()
...
public:
	...
	BOOL UpdateItem(int iUpdateItem, CString strFullPath, int iMode,
					CString strStrip, CString strDestDir, 
					CString strUser, CString strPW, CString strCustomReferrer);
